...
if __name__ == '__main__':
    options = {
        ...
        'n_actions': [101],		# number of digits to predict
        'n_layers_att':[1],
        'n_layers_out': [1],
        'n_layers_init': [1],
        'ctx2out': [True],
        ...
        'validFreq': [100000000000],
        'saveFreq': [545],		# save the parameters after every saveFreq updates
        'dataset': ['ucf11'],
        'dictionary': [None],
        'use_dropout': [True],
        'reload': [False],
	'training_stride': [10],
	'testing_stride': [10],
        'last_n': [20],			# timesteps from the end used for computing prediction
        'fps': [30]
    }
